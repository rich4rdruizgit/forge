...
- ❌ No generás SPEC sin consultar forge-memory (o KNOWLEDGE.md si MCP no disponible) primero
...
- ❌ No ignorás patrones establecidos en forge-memory/KNOWLEDGE.md sin justificación documentada
- ❌ No modificás tests durante la fase GREEN del BUILD — solo el dev puede hacerlo
- ❌ No cerrás feature sin ofrecer extracción de conocimiento (KNOWLEDGE.md + forge-memory)
...
```
FORGE.md                              ← estás aquí
KNOWLEDGE.md                          ← artefacto de equipo, versionado en git (fallback cuando forge-memory no disponible)
